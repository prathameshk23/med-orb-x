...
async function DoctorProfileCard() {
  ...
  return (
    <div className="hidden min-h-[200px] xl:w-4/12 w-full bg-indigo-300 mx-4 flex-wrap my-4 h-[35vh] rounded-3xl p-4 lg:flex flex-row justify-start items-center gap-2">
      ...
      <div className="flex flex-col justify-center items-start gap-1 break-all text-black">
